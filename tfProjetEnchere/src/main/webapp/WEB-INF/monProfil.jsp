...
<body>
	...
	<main>
		...
		<c:if test="${errorPasswordProfil}">
			<div class="alert alert-danger container d-flex align-items-center"
				type="alert">
		...
		<div class="container col-12 col-sm-10 col-md-8 col-lg-7 col-xl-4">
			<section
				class="d-flex justify-content-center border rounded-2 p-4 bg-white shadow-1">
				<div class="col-12 col-lg-10">
					<form class="d-flex flex-column align-items-center" method="post"
						...
						<!-- Code Postal input -->
						<div
							class="d-flex justify-content-between col-12 col-sm-11 col-md-11 gap-2">
							<div class="form-outline mb-4">
						...
						<div class="form-outline mb-4 col-12 col-sm-11 col-md-11">
							<input type="password" name="profilPassword"
								id="registerPassword" class="form-control" /> <label
								class="form-label" for="registerPassword">Mot de Passe</label>
						</div>
						<!-- New Password input -->
						<div class="col-12 col-sm-11 col-md-11">
							<div class="form-outline mb-4">
								<input type="password" name="profilNewPassword"
									id="registerNewPassword" class="form-control" /> <label
									class="form-label" for="registerNewPassword">Nouveau
									Mot de Passe</label>
							</div>
							<!-- Check new password input -->
							<div class="form-outline mb-4">
								<input type="password" name="profilPasswordConf"
									id="registerPasswordConf" class="form-control" /> <label
									class="form-label" for="registerPasswordConf">Confirmation</label>
							</div>
						</div>
						...
						<!-- Bouton Input -->
						<div
							class="d-flex flex-column align-items-center justify-content-center col-12 gap-4 text-center">
							<div class="col-12 col-sm-8 col-lg-9 text-center">
								<div class="form-outline">
									<button type="submit"
										class="btn btn-primary btn-block shadow-1" name="modifier">ENREGISTRER</button>
								</div>
							</div>
							<div class="col-12 col-sm-8 col-lg-9 text-center">
								<div class="form-outline">
