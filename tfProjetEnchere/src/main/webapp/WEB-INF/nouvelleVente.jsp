...
<body>
	...
	<main>
		<div class="container img-article mt-3 d-flex justify-content-center">
			<img src="${pageContext.request.contextPath}/img/logo-ENI-full.png"
				width="200" />
		</div>
		<p class="h4 my-3 text-center">AJOUTER UN ARTICLE</p>
		<div class="container col-12 col-sm-6 col-md-5 col-lg-4 w-responsive">
			<section
				class="container d-flex justify-content-center border rounded-2 p-4 bg-white shadow-1">
					...
					<div class="d-flex flex-column">
						...
						<div class="col-12">
							...
							<div class="form-outline mb-3">
								<input type="text" id="formNomArticle" name="registerArticle"
									...
									name="registerArticle" for="formNomArticle">Article</label>
							</div>

							<div class="form-outline mb-3">
								<textarea class="form-control" id="textAreaDescription"
									name="registerDescription" rows="4" required></textarea>
								<label class="form-label" name="registerDescription"
									for="textAreaDescription">Description</label>
							</div>

							<div class="form-group mb-3">
								<select class="form-select" name="registerCategorie"
									aria-label="Default select example" required>
									<c:forEach var="cat" items="${liste}">
							...
							<div class="form-outline mb-3">
								<input type="text" id="textAreaURLPhoto" name="registerPhoto"
									class="form-control" required /> <label class="form-label"
									name="registerPhoto" for="textAreaURLPhoto">URL Photo
									(local : img/articles-img/image.png)</label>
							</div>

							<div class="form-outline mb-3">
								<input type="number" id="typeNumber" name="registerMisaAPrix"
									class="form-control" required /> <label class="form-label"
									name="registerMisaAPrix" for="typeNumber">Mise à prix</label>
							</div>

							<div class="form-outline mb-3">
								<input type="date" id="typeDateDebut" name="registerDateDebut"
									class="form-control" required /> <label class="form-label"
									name="registerDateDebut" for="typeDateDebut">Date Début
									Enchère</label>
							</div>

							<div class="form-outline mb-3">
								<input type="date" id="typeDateFin" name="registerDateFin"
									class="form-control" required /> <label class="form-label"
									name="registerDateFin" for="typeDateFin">Date Fin
									Enchère</label>
							</div>
						</div>
						...
						<div class="col-12 mt-3 text-center">
							...
							<a href="<%=request.getContextPath()%>"><button type="button"
									class="btn btn-outline-danger shadow-1 mb-2">Annuler
									la vente</button></a>
						</div>
