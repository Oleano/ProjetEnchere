...
public interface EnchereDAO {
	...
	public List<Enchere> selectEnchereByNameByCategorieDisconect(String filtreNom, int filtreIdCategorie)
			throws DALException, SQLException;

	public List<Enchere> selectEnchereByNameConected(String filtreNom, int idUtilisateur)
			throws DALException, SQLException;

	public List<Enchere> selectEnchereByCategorieConected(int filtreIdCategorie, int idUtilisateur)
			throws DALException, SQLException;

	public List<Enchere> selectEnchereByNameByCategorieConected(String filtreNom, int filtreIdCategorie,
			int idUtilisateur) throws DALException, SQLException;
