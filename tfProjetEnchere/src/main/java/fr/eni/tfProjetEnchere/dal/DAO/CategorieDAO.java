...
public interface CategorieDAO {
	...
	public void deleteCategorie(Categorie noCategorie) throws DALException, SQLException;
	
	public List<Categorie> selectAllCategorie() throws DALException, SQLException;
	public List<Categorie> selectCategorieByNo(int noCategorie) throws DALException, SQLException;
